...
#ifndef AWESOME_COMMON_LUACLASS_H
#define AWESOME_COMMON_LUACLASS_H
...
struct lua_class_t
{
    ...
    /** Function to call when indexing an unknown property */
    lua_class_propfunc_t index_miss_property;
    /** Function to call when setting an unknown property */
...
void luaA_class_cleanup_reloadable(lua_State *);
